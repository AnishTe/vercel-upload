                                                        ...
                                                        <TableRow>
                                                            <TableCell className="p-0">
                                                                <Table className="w-full border border-gray-700 bg-gray-300 bg-[#666666] text-white">
                                                                    <TableRow>
                                                                        {/* First Cell */}
                                                                        <TableCell className="w-[200px] text-center align-middle p-2 text-[10px]text-[9px] font-bold leading-tight border border-gray-400 text-white">
                                                                            COMMON BID CUM
                                                                            <br />
                                                                            APPLICATION FORM
                                                                        </TableCell>
                                                                        ...
                                                                        {/* Second Cell */}
                                                                        <TableCell className="w-[434px] text-center p-2 text-[10px]text-[10px] leading-tight border border-gray-400">
                                                                        ...
                                                                        <TableCell
                                                                            ...
                                                                            className="w-[200px] text-center p-2 text-[10px]text-[9px] leading-tight border border-gray-400"
                                                                        >
                                                                            {categoryDescription || ""}

...
import { deleteOrderIPOClient, viewAppliedIPOClient } from "@/api/auth"
...
export default function ViewOrders() {
    ...
    const fetchAppliedIPOData = useCallback(async () => {
        ...
        setError(null)
        try {
            const response = await viewAppliedIPOClient({ _t: new Date().getTime() })
    ...
    const handleDeleteOrder = async () => {
        ...
        try {
            const response = await deleteOrderIPOClient({
                // pan: selectedRow.pan,
                ...
                <div className="space-y-4">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <Button onClick={() => router.push(getCompatibleUrl("/client/dashboard/ipo"))} className="mt-4">
                                Back to IPO List
                            </Button>
                        </CardContent>
                    </Card>
                    ...
                    >
                        <DialogHeader>
                            ...
                            <DialogDescription className="py-2 m-4 text-md">
                                Are you sure you want to delete this <span className="font-bold">{selectedRow?.companyname || ""}</span>{" "}
                                IPO order?
                            </DialogDescription>
                        </DialogHeader>

...
const fileGenerationSchema = z.object({
  ...
  orderType: z.enum(["CDSL OTHER", "NSDL OTHER"], {
      ...
      <DialogContent>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            {/* File for - Order Type Selection */}
            <FormField
              control={form.control}
              name="orderType"
              render={({ field }) => (
                <FormItem>
                  <FormLabel>File for: </FormLabel>
                  <FormControl>
                    <RadioGroup
                    ...
                    >
                      <FormItem className="flex items-center space-x-3 space-y-0">
                        <FormControl>
                          <RadioGroupItem value="CDSL OTHER" />
                        </FormControl>
                        <FormLabel className="font-normal">CDSL OTHER</FormLabel>
                      </FormItem>
                      <FormItem className="flex items-center space-x-3 space-y-0">
                        <FormControl>
                          <RadioGroupItem value="NSDL OTHER" />
                        </FormControl>
                        <FormLabel className="font-normal">NSDL OTHER</FormLabel>
                      </FormItem>
                    </RadioGroup>
                  </FormControl>
                  <FormMessage />

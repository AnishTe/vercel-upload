...
// const createFormSchema = (depositoryType: "CDSL" | "NSDL") => {
//   const baseSchema = {
...
// type CDSLFormValues = z.infer<ReturnType<typeof createFormSchema<"CDSL">>>
// type NSDLFormValues = z.infer<ReturnType<typeof createFormSchema<"NSDL">>>

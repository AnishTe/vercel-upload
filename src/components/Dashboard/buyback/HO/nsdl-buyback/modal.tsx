        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid grid-cols-4 items-center gap-4">
                  <FormLabel className="text-right">BranchCode</FormLabel>
                  <div className="col-span-3">
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
              ...
              render={({ field }) => (
                <FormItem className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3 flex">
                    {/* className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-blue-600 bg-blue-600 text-white text-sm font-medium" */}

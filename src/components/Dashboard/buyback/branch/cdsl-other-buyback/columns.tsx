...
export type CDSLOtherBuybackOrdersBranch = {
  orderStatus: any;
  id: number
  isin: string
  branchcode: string
  ...
  appliedDate: string
  original: any
  onDelete?: (order: CDSLOtherBuybackOrdersBranch) => void
}
...
export const columns: CustomColumnDef<CDSLOtherBuybackOrdersBranch>[] = [
  {
    id: "isin",
    accessorKey: "isin",
    header: "ISIN",

...
export default function ITReportMCXPage() {
    ...
    const fetchAnnualPLData = async (fromDate: string, toDate: string) => {
        ...
        setLoading(true);
        try {
            const response = await annualPLMCX({ fromDate, toDate });
                    ...
                    <Card>
                        <CardHeader className="flex flex-col md:flex-col sm:flex-col  mb-4">
                            <div className="flex-1">
                                <CardTitle>IT Report MCX</CardTitle>
                            </div>
                                ...
                                <>
                                    ...
                                    <div key={"trading"} id={"trading"} className="my-8">
                                        ...
                                        <DataTableArray
                                            ...
                                            downloadFileName={"IT_Report_MCX"}

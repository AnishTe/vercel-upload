...
"use client"
import { mailBounceCount } from "@/lib/auth"
...
export default function MailBounceCount() {
    ...
    const handleSearch = async () => {
        ...
        setError(null)
        try {
            const response = await mailBounceCount({ searchDate: date.trim() })
                ...
                <div className="space-y-4">
                    <Card className="w-full shadow-lg">
                        <CardHeader className="flex flex-col sm:flex-row gap-2">
                            <CardTitle className="text-center">Mail Bounce Whatsapp Count More Than 3 For Last 30days From Selected Date</CardTitle>
